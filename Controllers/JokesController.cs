...
using JokeRegistryWebApp.Data;
using JokeRegistryWebApp.Models;
using Microsoft.AspNetCore.Authorization;

namespace JokeRegistryWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        {
            return View();
            //we couldve done return View("ShowSearchForm"); but since the method name is already that title we can leave it empty
        }
